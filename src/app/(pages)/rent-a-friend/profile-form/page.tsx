...
const Rentalprofile = () => {
  ...
  const handleImageChange = (
    ...
    setPreview: React.Dispatch<React.SetStateAction<string | null | File>>
  ) => {
    ...
    try {
      ...
      if (photoFiles && photoFiles.length > 0) {
        for (const photoFile of photoFiles) {
          const photoFileName = `photo_${profileId}_${Date.now()}_${
            photoFile.name
          }`;
    ...
    <div>
      <div>
        <Card className="max-w-2xl mt-6 mx-auto">
          <CardHeader>
            <CardTitle className="text-2xl border-b-2">
              Create Your Rental profile
            </CardTitle>
            <CardDescription>
              Tell us about yourself to set up your profile so, users can find
              interest in you.
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <span className="text-[12px] tracking-tighter text-gray-400 ">
                    Don&apos;t worry about the size, your picture is visible in full
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        >
                          <option
                            className="bg-zinc-700 text-slate-800"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="Travelling,Career guidence, Movie date etc.. (comma separated)"
                          required
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
                        Add the services you are available for, separated by
                        commas.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Add the services charge, choose a decent amount In US
                        DOLLERS .
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
