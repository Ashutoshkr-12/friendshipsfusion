...
// import { resetPassword } from '@/serverActions/authAction';
...
//         >
//           <label className="text-md" htmlFor="password">New Password</label>
...
//           <label className="text-md mt-4" htmlFor="confirmPassword">Confirm New Password</label>
//           <input
