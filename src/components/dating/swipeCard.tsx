      ...
      <ScrollArea className="h-full scroll-smooth" onScroll={handleScroll}>
        ...
        <div className="bg-white dark:bg-gray-900 p-6 space-y-6">
          ...
          <div className="space-y-2 border-b py-2">
            <h4 className="font-semibold text-lg flex items-center gap-1"><MessageSquareWarning size={20}/>About</h4>
       ...
       <div className='flex items-center gap-2'>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {profile.photo_url.map((photo, index) => (
                <div key={index} className="flex items-center gap-1 bg-gray-100 dark:bg-gray-800  px-1 py-0.5 rounded-full">
